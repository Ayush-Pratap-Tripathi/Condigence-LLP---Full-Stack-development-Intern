            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 bg-gray-50 px-3 py-2 rounded-lg break-all">
                    {profile.email}
                  </p>
                </div>
                ...
                <div className="flex justify-end pt-4 border-t border-gray-200">
                  <motion.button
                    ...
                    className={`
                      ...
                      ${
                        saving
                          ? "bg-gray cursor-not-allowed text-gray-700"
                          : "bg-primary hover:bg-primary/90 text-gray-700 shadow-md hover:shadow-lg"
                      }
                    `}
                  >
                    {saving ? (
